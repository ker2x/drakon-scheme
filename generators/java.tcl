...
proc extract_signature { text name } {
    ...
    while { 1 } {
        ...
        } elseif {$_next_item_ == 678} {
            set count [ llength $lines ]
            #item 6810001
            set i $start_index
            set _next_item_ 6810002
    
        } elseif {$_next_item_ == 6810002} {
            if {$i < $count} {
                #item 680
        ...
        } elseif {$_next_item_ == 6810003} {
            incr i
            set _next_item_ 6810002
    
        } elseif {$_next_item_ == 897} {
            if {$type == "ctr"} {
                set _next_item_ 898
            } else {
                set _next_item_ 902
